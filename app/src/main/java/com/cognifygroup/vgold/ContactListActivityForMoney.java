...
public class ContactListActivityForMoney extends AppCompatActivity implements AlertDialogOkListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressDialog = new TransparentProgressDialog(ContactListActivityForMoney.this);
            ...
            public <T> void onSuccess(T serviceResponse) {
                try {
                    ...
                    if (status.equals("200")) {
                        ...
                        if (!data) {
                            AlertDialogs.alertDialogOk(ContactListActivityForMoney.this, "Alert", message + ",  Please relogin to app",
                                    getResources().getString(R.string.btn_ok), 11, false, alertDialogOkListener);
                        }

                    } else {
                        AlertDialogs.alertDialogOk(ContactListActivityForMoney.this, "Alert", message,
            ...
            public <T> void onFailure(T apiErrorModel, T extras) {
                ...
                try {
                    ...
                    if (apiErrorModel != null) {
                        PrintUtil.showToast(ContactListActivityForMoney.this, ((BaseServiceResponseModel) apiErrorModel).getMessage());
                    } else {
                        PrintUtil.showNetworkAvailableToast(ContactListActivityForMoney.this);
                    }
                } catch (Exception e) {
                    progressDialog.hide();
                    e.printStackTrace();
...
//        Log.e("number is", phonenUmber[1]);
    ...
    public void onDialogOk(int resultCode) {
        switch (resultCode) {
            case 11:
                Intent LogIntent = new Intent(ContactListActivityForMoney.this, LoginActivity.class);
