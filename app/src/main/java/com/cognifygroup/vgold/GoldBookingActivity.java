            ...
            public <T> void onSuccess(T serviceResponse) {
                try {
                    ...
                    if (status.equals("200")) {
                        ...
                        if (!data) {
                            AlertDialogs.alertDialogOk(GoldBookingActivity.this, "Alert", message + ",  Please relogin to app",
...
//                        mAlert.onShowToastNotification(AddGoldActivity.this, message);
    ...
    private void AttemptToGetGoldBooking(final String quantity, final String tennure,
                                         final String pc) {
        progressDialog.show();
        goldBookingServiceProvider.getAddBankDetails(quantity, tennure, pc,VGoldApp.onGetUerId(), new APICallback() {
            @Override
            public <T> void onSuccess(T serviceResponse) {
                try {
    ...
    public void onDialogOk(int resultCode) {
        switch (resultCode){
            case 1:
                ...
                break;
            case 11:
                Intent LogIntent = new Intent(GoldBookingActivity.this, LoginActivity.class);
