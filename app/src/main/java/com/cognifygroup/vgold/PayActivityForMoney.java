            ...
            public <T> void onSuccess(T serviceResponse) {
                try {
                    ...
                    if (status.equals("200")) {
                        ...
                        if (!data) {
                            AlertDialogs.alertDialogOk(PayActivityForMoney.this, "Alert", message + ",  Please relogin to app",
...
//                        mAlert.onShowToastNotification(PayActivityForMoney.this, message);
    ...
    public void onDialogOk(int resultCode) {
        ...
        switch (resultCode){
            ...
            case 11:
                Intent LogIntent = new Intent(PayActivityForMoney.this, LoginActivity.class);
